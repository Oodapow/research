...
curl -fsSL https://raw.githubusercontent.com/Oodapow/research/master/infrastructure/l1/postgresql/os/ubuntu/listen-to-all.sh | bash -s -- $(find / -name "postgresql.conf" -print -quit) && \
