...
curl -fsSL https://raw.githubusercontent.com/Oodapow/research/master/infrastructure/l1-machine/postgresql/os/ubuntu/edit-postgresql-conf.sh | bash -s -- $(find / -name "postgresql.conf" -print -quit)
curl -fsSL https://raw.githubusercontent.com/Oodapow/research/master/infrastructure/l1-machine/postgresql/os/ubuntu/edit-pghba-conf.sh | bash -s -- $(find / -name "pg_hba.conf" -print -quit) && \
